...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"updateAll.js":[function(require,module,exports) {
"use strict";
...
class UpdateAll extends _react.Component {
  constructor(props) {
    super(props);
    this.state = {
      exchanges: [],
  ...
  render() {
    ...
    return logs.map(l => _react.default.createElement(_ink.Color, {
      green: true
    }, l));
  }
