export default class Token {
    constructor(contractAddress = '', decimals = 18, name = '', symbol = '', image = '', price = {}, balance = 0, balanceDecimals = 0) {
        ...
        this.usdValue = price && price.rate ? (parseFloat(price.rate) * parseFloat(balance)) : 0;
    }

    calcUsdValue() {
        this.usdValue = this.price && this.price.rate ? (parseFloat(this.price.rate) * parseFloat(this.balance)) : 0;
    }
}