...
import Compound2 from './defi/Compound2';
import Fulcrum from './defi/Fulcrum';
...
export default class EthereumHDWallet extends HDWallet{
    ...
    constructor(secret = null, address=null) {
        ...
        this.transactions = [];
        this.usedAddresses = [];
        this.plugins = [{name: "Fulcrum", class:Fulcrum}, {name: "Compound2", class: Compound2}, {name:'Ethlend', class: Ethlend}, { name: 'Compound', class: Compound}, {name: 'Uniswap', class: Uniswap}, {name: 'Maker', class: Maker}, {name: 'Livepeer', class: Livepeer}, {name: 'Dydx', class: Dydx}]
    ...
    async export() {
        ...
        const wallet = {
            ...
            fulcrum: this.Fulcrum.portfolio,
            uniswap: this.Uniswap.portfolio,
            compound: this.Compound.portfolio,
            compound2: this.Compound2.portfolio,
            dydx: this.Dydx.portfolio
        };
        console.log('CDPS', wallet.CDPS);
    ...
    async getAccountNetWorth() {
        ...
        await this.Fulcrum.getState();

        await this.Compound2.getState();
        this.Compound2.portfolio.forEach( t => {
