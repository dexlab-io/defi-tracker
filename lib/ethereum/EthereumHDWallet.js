...
export default class EthereumHDWallet extends HDWallet{
    ...
    constructor(secret = null, address=null) {
        ...
        this.transactions = [];
        this.usedAddresses = [];
        this.plugins = [{name: "Compound2", class: Compound2}, {name:'Ethlend', class: Ethlend}, { name: 'Compound', class: Compound}, {name: 'Uniswap', class: Uniswap}, {name: 'Maker', class: Maker}, {name: 'Livepeer', class: Livepeer}, {name: 'Dydx', class: Dydx}]
