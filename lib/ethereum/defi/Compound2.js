...
class Compound2 {
    constructor(wallet) {
        ...
        this.cacheApi = null;
        this.portfolio = [
            { contractAddress: '0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359', cTokenAddress:"0xf5dce57282a584d2746faf1593d3121fcac444dc", name: 'DAI', symbol:'DAI', decimals:18},
            { contractAddress: '0xe41d2489571d322189246dafa5ebde1f4699f498', cTokenAddress:"0xb3319f5d18bc0d84dd1b4825dcde5d5f7266d407", name: 'ZRX', symbol:'ZRX', decimals:18},
            { contractAddress: '0x0d8775f648430679a709e98d2b0cb6250d2887ef', cTokenAddress:"0x6c8c6b02e7b2be14d4fa6022dfd6d75921d90e4e", name: 'BAT', symbol:'BAT', decimals:18},
            { contractAddress: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2', cTokenAddress:"0x4ddc2d193948926d02f9b1fe9e1daa0718270ed5", name: 'WETH', symbol:'WETH', decimals:18},
            { contractAddress: '0x1985365e9f78359a9B6AD760e32412f4a445E862', cTokenAddress:"0x158079ee67fce2f58472a96584a73c7ab9ac95c1", name: 'REP', symbol:'REP', decimals:18},
            { contractAddress: '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48', cTokenAddress:"0x39aa39c021dfbae8fac545936693ac917d5e7563", name: 'USDC', symbol:'USDC', decimals:6},
            { contractAddress: '0x2260fac5e5542a773aa44fbcfedf7c193bc2c599', cTokenAddress:"0xc11b1268c1a384e55c48c2391d8d480264a3a7f4", name: 'WBTC', symbol:'WBTC', decimals:8},  
        ];
    }
    ...
    findTokenBycAddress(contractAddress) {
        if( isUndefined(contractAddress) || contractAddress === '' ) throw new Error(`contractAddress: is undefined`);
        const idx = findIndex(this.portfolio, (o) => { 
            return o.cTokenAddress.toString().toLowerCase().trim() === contractAddress.toString().toLowerCase().trim(); 
        });
        if( idx < 0) {
            return false;
        }
    ...
    async getApiValues() {
        return fetch(`https://api.compound.finance/api/v2/account?addresses[]=${this.W.getAddress()}`)
    ...
    async getSupplyBalance(tokenAddress) {
        ...
        const balanceOfUnderlying = (await cToken.methods.balanceOfUnderlying(this.W.getAddress()).call());
