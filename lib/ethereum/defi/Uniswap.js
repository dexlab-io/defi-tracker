...
class Uniswap {
    ...
    async getMarketData(item) {
        ...
        var fromBlock = this.originBlock;
    ...
    async getTokenState(item) {
        ...
        // let share = await exchangeContract.methods.balanceOf('0xf6B6F07862A02C85628B3A9688beae07fEA9C863').call();
        // if(item.symbol === 'KNC') {
        ...
        if (share.toString() !== '0'){
            ...
            // if(item.symbol === 'KNC') {
            //     console.log('shareConverted', shareConverted.toNumber())
            // }
            ...
            // if(item.symbol === 'KNC') {
            //     console.log('ethWithdrawValue', this.W.web3.utils.fromWei( (ethWithdrawValue.toNumber() * 1e18).toString(), 'ether' ) )
            // }
            ...
            // if(item.symbol === 'KNC') {
            //     console.log('erc20WithdrawValueWei', erc20WithdrawValueWei.toNumber())
            //     console.log('---------------------------------')
            // }
